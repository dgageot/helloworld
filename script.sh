...
gcutil \
	--service_version=v1 \
	--project=numeric-scope-568 \
addinstance hello \
	--zone=europe-west1-b \
	--machine_type=n1-standard-1 \
	--tags=http-server \
	--image="https://www.googleapis.com/compute/v1/projects/debian-cloud/global/images/backports-debian-7-wheezy-v20140415"
...
gcloud compute instances create jug \
